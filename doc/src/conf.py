...
sys.path.append(os.path.abspath('../../rbnworld'))
...
latex_documents = [
  ('index', 'rbnworld.tex', u'RBNWorld Documentation',
...
man_pages = [
    ('index', 'rbnworld', u'RBNWorld Documentation',
